...
public class Goat extends Animal implements IMilkable{
    ...
    private final String[] NAMES = new String[]{
            "Gogo1", "Gogo2", "Gogo3", "Gogo", "Gogo",
            "Gogo", "Gogo", "Gogo", "Gogo", "Gogo",
            "Gogo11", "Gogo12", "Gogo13", "Gogo14", "Gogo15",
            "Gogo16", "Gogo17", "Gogo18", "Gogo19", "Gogo20",
            "Gogo21", "Gogo22", "Gogo23", "Gogo24", "Gogo25",
            "Gogo26", "Gogo27", "Gogo28", "Gogo29", "Gogo30",};
    String nameGoat = NAMES[new Random().nextInt(NAMES.length) ];


    public Goat(String type, int age, double weight,  int udderCapacity ) {
...
//        this.id = autoGeneratedID.getNextId();
    ...
    public Goat(int id, String type, int age, double weight,  String name,  int udderCapacity) {
